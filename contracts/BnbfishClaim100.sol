...
/// @notice Cost baseline only; NOT the proposed hash-only low-operator-cost architecture.
...
contract BnbfishClaim100 is ERC721Enumerable, Ownable2Step, ReentrancyGuard {
 ...
 uint256 public constant INTERVAL=100;
 ...
 ERC721("Bnbfish Claim 100","BNBFISH100") Ownable(admin) {
